...
st.title(" Custom Quantum Gates Simulation")
...
#while True:
algorithm_text=st.text_input("Enter the basic Algorithm that you want to simulate")
#st.write(f"Received algorithm: {algorithm_text}")
...
#    image_data = image_file.read()
    print(f"Image successfully processed and saved as '{image_path}'.")
